...
// Props for the SnippetCommentsSection component
interface SnippetCommentsSectionProps {
  snippetId: string;
}

// Comments section component
export const SnippetCommentsSection: React.FC<SnippetCommentsSectionProps> = ({ snippetId }) => {
  // Get comments for this snippet
  const { data: comments, isLoading: commentsLoading } =
    api.snippet.getCommentsBySnippetId.useQuery({ snippetId });
          ...
          {commentsLoading ? (
            ...
            <div className="flex flex-col items-center justify-center py-12 text-center">
              ...
              <p className="mt-1 text-sm text-muted-foreground">
                Be the first to comment on this code snippet
              </p>
            </div>
          )}
        </div>
