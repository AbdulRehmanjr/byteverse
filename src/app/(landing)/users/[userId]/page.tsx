...
import { MessageButton } from "~/components/users/message-button";
...
export default async function UserProfilePage({ params }: PageProps) {
  ...
  const userData = await api.profile.getProfileById({
    userId: paramProps.userId,
  });
    ...
    <section className="mx-auto px-4 py-8">
      ...
      <Card className="mb-8 overflow-hidden border-t-4 border-t-primary">
        ...
        <CardContent className="relative pb-6 pt-0">
          <div className="flex flex-col items-start justify-between gap-4 sm:flex-row sm:items-center">
              ...
              <div>
                <div className="flex items-center gap-2">
                  ...
                  {user.isVerified && (
                    <Badge
                      variant="outline"
                      className="px-2 py-0 font-text text-xs text-primary"
                    >
                      ✓ Verified
                    </Badge>
                  )}
                ...
                <div className="flex flex-col gap-1">
                  ...
                  <p className="flex items-center font-text text-sm text-muted-foreground">
                    <Star className="mr-1 h-4 w-4 text-amber-500" />
                    <span className="font-medium">
                      {user.reputation?.toLocaleString() || 0}
                    </span>
                    <span className="ml-1 font-text">reputation</span>
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="flex flex-col items-end gap-2">
              <div className="flex gap-2">
                ...
                <MessageButton userId={user.userId} userName={userData.userName} />
          ...
          <div className="mt-6 flex flex-wrap gap-4 font-text">
            {user.location && (
      ...
      <div className="grid grid-cols-1 gap-6 md:grid-cols-3">
        <Card className="md:col-span-2">
          ...
          <CardContent>
            <div className="mb-6">
              <h3 className="mb-2 font-heading font-semibold">Top Tags</h3>
            ...
            <div className="mb-6">
              <h3 className="mb-2 font-heading font-semibold">Stats</h3>
              <div className="grid grid-cols-2 gap-4 sm:grid-cols-4">
                ...
                <div className="flex flex-col items-center rounded-lg bg-muted p-3">
                  <span className="text-2xl font-bold">
                    {user.reputation
                      ? Math.round((user.reputation / 100) * 10) / 10
                      : 0}
                    k
                  </span>
                  <span className="text-xs text-muted-foreground">
        ...
        <Card>
          ...
          <CardContent>
            {questions.length > 0 ? (
              ...
              <p className="text-center font-text text-muted-foreground">
                No recent activity
              </p>
            )}
          </CardContent>
